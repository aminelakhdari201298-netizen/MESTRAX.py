...
# Configuration
# ─────────────────────────────────────────────────────────────
BOT_TOKEN = os.environ.get("8793194323:AAHpjf4_Z_IbORm-5uBDKJSrLx5xlG7uY6o", "").strip()
OWNER_ID = int(os.environ.get("8254258071", "8254258071"))
OWNER_PASSWORD = os.environ.get("MESTRAXLKBOT", "").strip()
BOT_OWNER_NAME = os.environ.get("MESTRAX PROXY PREMIUM", "MESTRAX PROXY PREMIUM").strip()
